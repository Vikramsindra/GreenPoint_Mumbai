...
const testManualEntry = async () => {
  try {
    ...
    // Test manual entry
    const apiURL = 'http://10.147.22.121:5000/api/bmc-collections';
    console.log('\n📝 Testing Manual Entry Submission...');
    ...
    const payload = {
      ...
      manualPointName: 'Manual Test Society',
    ...
    if (response.data?.success) {
      console.log('\n✅ SUCCESS! Manual entry was accepted');
      console.log('Collection ID:', response.data.data._id);
